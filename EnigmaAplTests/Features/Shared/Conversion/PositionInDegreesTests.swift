...
struct PositionInDegreesTests {
    ...
    func testDoubleToDmsPositive() {
        let result = PositionInDegrees.DoubleToDms(45.5125)
    ...
    func testDoubleToDmsSignAries() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(15.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
        #expect(sign == .Aries)
    }
    ...
    func testDoubleToDmsSignTaurus() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(45.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
        #expect(sign == .Taurus)
    }
    ...
    func testDoubleToDmsSignGemini() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(75.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
        #expect(sign == .Gemini)
    }
    ...
    func testDoubleToDmsSignCancer() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(105.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
        #expect(sign == .Cancer)
    }
    ...
    func testDoubleToDmsSignLeo() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(135.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
        #expect(sign == .Leo)
    }
    ...
    func testDoubleToDmsSignVirgo() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(165.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
        #expect(sign == .Virgo)
    }
    ...
    func testDoubleToDmsSignLibra() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(195.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
        #expect(sign == .Libra)
    }
    ...
    func testDoubleToDmsSignScorpio() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(225.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
        #expect(sign == .Scorpio)
    }
    ...
    func testDoubleToDmsSignSagittarius() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(255.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
    ...
    func testDoubleToDmsSignCapricorn() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(285.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
    ...
    func testDoubleToDmsSignAquarius() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(315.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
    ...
    func testDoubleToDmsSignPisces() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(345.51251)
        #expect(success == true)
        #expect(dms == "15°30'45\"")
        #expect(sign == .Pisces)
    }
    ...
    func testDoubleToDmsSignBoundaryZero() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(0.0)
        #expect(success == true)
        #expect(dms == "0°00'00\"")
        #expect(sign == .Aries)
    }
    ...
    func testDoubleToDmsSignBoundaryThirty() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(30.0)
        #expect(success == true)
        #expect(dms == "0°00'00\"")
        #expect(sign == .Taurus)
    }
    ...
    func testDoubleToDmsSignJustBeforeThirty() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(29.9999)
        #expect(success == true)
        #expect(sign == .Aries)
    }
    ...
    func testDoubleToDmsSignBoundary359() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(359.999)
        #expect(success == true)
    ...
    func testDoubleToDmsSignError360() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(360.0)
    ...
    func testDoubleToDmsSignErrorGreaterThan360() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(450.0)
        #expect(success == false)
        #expect(dms == "")
        #expect(sign == nil)
    }
    ...
    func testDoubleToDmsSignErrorNegative() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(-15.0)
        #expect(success == false)
        #expect(dms == "")
        #expect(sign == nil)
    }
    ...
    func testDoubleToDmsSignErrorSmallNegative() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(-0.1)
        #expect(success == false)
        #expect(dms == "")
        #expect(sign == nil)
    }
    ...
    func testDoubleToDmsSignErrorLargeNegative() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(-100.0)
        #expect(success == false)
        #expect(dms == "")
        #expect(sign == nil)
    }
    ...
    func testDoubleToDmsSignZeroPadding() {
        let (dms, sign, success) = PositionInDegrees.DoubleToDmsSign(12.0505)
        #expect(success == true)
    ...
    func testDoubleToDegreesPositiveDefault() {
        let result = PositionInDegrees.DoubleToDegrees(45.5125)
        #expect(result == "45.51°")
    }
